...
// Definir el modelo 'Actor' utilizando Sequelize
const Actor = sequelize.define('Actor', {
    ...
    nombre: {
        ...
        validate: {
            ...
            notEmpty: {
                msg: 'El nombre del actor no puede estar vacío', // Mensaje de error si está vacío
            },
            len: {
                args: [1, 100], // Longitud permitida entre 1 y 100 caracteres
                msg: 'El nombre del actor debe tener entre 1 y 100 caracteres', // Mensaje de error si no cumple la longitud
            },
            is: {
                // Validación mediante expresión regular
                args: /^[a-zA-Z\s]+$/i, // Solo permite letras y espacios
                msg: 'El nombre solo puede contener letras y espacios', // Mensaje de error si contiene caracteres no válidos
            },
        },
    },
}, {
...
// Exportar el modelo 'Actor' para ser utilizado en otras partes de la aplicación
